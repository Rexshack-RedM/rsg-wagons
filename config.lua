...
Config.Wagons = {
    work = {
        wagon02x = {
            ...
            slots = 20,                            -- Number of available slots
        ...
        cart05 = {
            ...
            slots = 20,                              -- Represents large containers/tank
        ...
        chuckwagon000x = {
            ...
            slots = 20,                               -- For food, utensils, etc.
        ...
        coal_wagon = {
            ...
            slots = 20,                      -- Fewer slots, for bulk items
            price = 100,
            maxAnimals = false,
        },
        ...
        huntercart01 = {
            ...
            slots = 20,      -- Space for pelts and various game
        ...
        oilwagon01x = {
            ...
            slots = 20,                              -- Fewer slots for barrels/tank
            price = 85,
            maxAnimals = false,
        },
        oilwagon02x = {
            ...
            slots = 20,                             -- More barrels/larger tank
            price = 110,
            maxAnimals = false,
        },
        supplywagon = {
    ...
    special = {
        gatchuck_2 = {       -- Wagon model hash
            ...
            slots = 20,      -- Spaces for ammo, essential supplies
        ...
        policewagon01x = {   -- Wagon model hash
            ...
            slots = 20,      -- Seats and space for equipment
        ...
        policewagongatling01x = { -- Wagon model hash
            ...
            slots = 20,            -- Spaces for ammo and tactical gear
        ...
        stagecoach004_2x = { -- Wagon model hash
            ...
            slots = 20,      -- Internal seats, luggage rack, safe
        ...
        stagecoach004x = {   -- Wagon model hash
            ...
            slots = 20,      -- Seats and cargo space
        ...
        wagonarmoured01x = { -- Wagon model hash
            ...
            slots = 20,      -- Secure and limited internal space
        ...
        wagoncircus01x = {   -- Wagon model hash
            ...
            slots = 20,      -- Space for items of various shapes
        ...
        wagoncircus02x = {   -- Wagon model hash
            ...
            slots = 20,      -- Space for people and their items
            price = 100,
        ...
        wagondairy01x = {    -- Wagon model hash
            ...
            slots = 20,      -- Space for many small containers
        ...
        wagondoc01x = {      -- Wagon model hash
            ...
            slots = 20,      -- Many small bottles and boxes
        ...
        wagonprison01x = {   -- Wagon model hash
            ...
            slots = 20,      -- Focus on security, cells, not miscellaneous cargo
        ...
        wagontraveller01x = { -- Wagon model hash
            ...
            slots = 20,       -- Good internal and possibly external space
            price = 110,
            maxAnimals = false,
        },
        wagonwork01x = {     -- Wagon model hash
            ...
            slots = 20,      -- Adaptable for different types of goods
            price = 75,
            maxAnimals = false,
        },
        warwagon2 = {        -- Wagon model hash
            ...
            slots = 20,       -- Very limited internal space due to armor and mechanisms
    ...
    coach = {
        coach2 = {
            ...
            slots = 20,                                  -- Seats and small space for luggage (ex: 2-3 people + luggage)
        ...
        coach3 = {
            ...
            slots = 20,                             -- Seats for 4 and space for hand luggage
        ...
        coach4 = {
            ...
            slots = 20,                 -- Spacious seats and area for picnic baskets, etc.
        ...
        coach5 = {
            ...
            slots = 20,                 -- Seats for 2 + space for the driver and minimal items
        ...
        stagecoach002x = {
            ...
            slots = 20,                     -- Similar configuration to the larger one, but on a smaller scale
        ...
        stagecoach005x = {
            ...
            slots = 20,                                     -- Optimized to maximize transport over long distances
        ...
        stagecoach006x = {
            ...
            slots = 20,                         -- Focus on number of seats, like a "trolley on wheels"
        ...
        stagecoach003x = {
            ...
            slots = 20,                                             -- Similar to the Fiacre, perhaps less ornate
        ...
        coach6 = {
            ...
            slots = 20,                                            -- Multiple seats, usually open
        ...
        buggy01 = {
            ...
            slots = 20,                                -- Seats for 2 and minimal space for belongings
        ...
        buggy02 = {
            ...
            slots = 20,                        -- Essentially the seats
        ...
        buggy03 = {
            ...
            slots = 20,                             -- Seats for four, usually 2 benches
